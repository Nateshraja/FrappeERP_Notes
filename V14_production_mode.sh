...
echo "⚙️ Enabling production setup..."
sudo bench setup production $(whoami)

# ========= CLEANUP & DONE =========
echo "✅ Setup Complete!"
echo "🌐 Access your site at: http://${sitename}"
echo "🛠 If using local domain like mysite.local, add '127.0.0.1 ${sitename}' to your /etc/hosts or DNS"
