...
sudo apt update
sudo apt install -y git python3-dev python3-pip python3-setuptools python3-distutils curl \
    redis-server software-properties-common mariadb-server mariadb-client libmysqlclient-dev \
